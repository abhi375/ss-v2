...
date: 2021-04-04
metaImage: "/customer-stories/medilink-story.png"
---
...
<div className="px-12 py-16 bg-gray-50 text-center rounded-lg">
  <div className="text-2xl font-semibold italic leading-snug mb-4">
    <span className="opacity-60 text-gray-400">"</span> Without seeing them
    physically, it was a challenge to monitor and coach the team.
    <span className="opacity-60 text-gray-400">"</span>
  </div>
  <div className="text-lg opacity-60">— Rosemarie Carpio</div>
</div>
