...
date: 2021-04-06
metaImage: "/customer-stories/endurance-story.png"
---
...
<div className="px-12 py-16 bg-gray-50 text-center rounded-lg">
  <div className="text-2xl font-semibold italic leading-snug mb-4">
    <span className="opacity-60 text-gray-400">"</span> We needed a telephony
    solution that leveraged our substantial Salesforce investment
...
<div className="px-12 py-16 bg-gray-50 text-center rounded-lg">
  <div className="text-2xl font-semibold italic leading-snug mb-4">
    <span className="opacity-60 text-gray-400">"</span> Studio is an amazing
    feature that allows us to build the IVR on the fly.
    <span className="opacity-60 text-gray-400">"</span>
  </div>
  <div className="text-lg opacity-60">
    — Mukhtadir Syed, AVP - Sales and Customer Success
...
<div className="px-12 py-16 bg-gray-50 text-center rounded-lg">
  <div className="text-2xl font-semibold italic leading-snug mb-4">
    <span className="opacity-60 text-gray-400">"</span>A solid CTI solution
